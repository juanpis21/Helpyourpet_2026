...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Convertir carrito activo en Venta' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, checkout_dto_1.CheckoutDto]),
    __metadata("design:returntype", Promise)
], VentasController.prototype, "checkout", null);
__decorate([
    (0, common_1.Get)('mis-compras'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener historial de compras del usuario' }),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], VentasController.prototype, "getMisCompras", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener todas las ventas del sistema (Admin)' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener detalle de una venta por ID' }),
